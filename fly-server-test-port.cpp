...
#ifndef _WIN32
		syslog(LOG_NOTICE, "IP Flood %s count = %d", p_remote_ip.c_str(), l_ip_stat.m_count);
#endif
		// return MG_FALSE;
	}
	if (l_ip_stat.isCheckPoint())
	{
		l_ip_stat.init(); // «а 10 сек не набрали много коннектов
	}
}
//==========================================================================
...
// END Process
			...
			*/
			// ƒокидываем второй командой данные (TODO - —клеить все в одну)
			// TODO - проверить бинарный 0x00
...
int main(int argc, char* argv[])
{
...
#endif
	// TODO - ѕереписать на цикл + массив
#ifndef _WIN32 // Only in linux
...
#endif
	std::cout << std::endl << "* FlylinkDC++ server for test port r727 (c) 2012-2019 pavel.pimenov@gmail.com " << std::endl
	...
	const char *options[] = {
		//	  "document_root", ".",
			  "listening_ports", "37016",
			  "num_threads", "5",
			  "enable_directory_listing", "no", 0
	};
